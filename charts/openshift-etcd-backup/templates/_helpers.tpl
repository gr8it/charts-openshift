...
{{- define "openshift-etcd.fullname" -}}
...
app.kubernetes.io/name: {{ include "openshift-etcd.name" . }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/instance: {{ include "openshift-etcd.fullname" . }}
app.kubernetes.io/version: {{ .Chart.Version | quote }}
helm.sh/chart: {{ include "openshift-etcd.chart" . }}
{{- end -}}
